...
import ru.padawans.moviesapp.ui.view.MovieViewHolder

class UpcomingMoviesViewHolder(view: View, val onItemClick: (Int) -> Unit) : RecyclerView.ViewHolder(view) {
companion object{
    fun create(parent: ViewGroup, onItemClick: (Int) -> Unit): UpcomingMoviesViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.upcoming_movie_item, parent, false)

        return UpcomingMoviesViewHolder(view,onItemClick)
    }
}
